...
<div class="post-img">
    ...
    <div class="m-auto blog-post-content max-width-2 m-auto my-2">
        <h1 class="font1"><?php echo get_the_title(); ?></h1>
        <div class="blogpost-meta">
            <div class="author-info">
                ...
                <div><?php echo(get_the_date()." ".get_the_time()); ?> | 6 min read</div>
            </div>
            <div class="social">
    ...
    <div class="home-articles max-width-1 m-auto font2">
        ...
        <div class="home-article more-post">
            <div class="home-article-img">
                <img src="<?php bloginfo('template_directory');?>/img/11.svg" alt="article">
            </div>
        ...
        <div class="home-article more-post">
            <div class="home-article-img">
                <img src="<?php bloginfo('template_directory');?>/img/1.png" alt="article">
            </div>
            <div class="home-article-content font1 center">
                <a href="/blogpost.html"><h3>Learn more about Machine Learning techniques in India by joining this channel</h3></a>
        ...
        <div class="home-article more-post">
            <div class="home-article-img">
                <img src="<?php bloginfo('template_directory');?>/img/2.png" alt="article">
            </div>
            <div class="home-article-content font1 center">
                <a href="/blogpost.html"><h3>Learn more about Machine Learning techniques in India by joining this channel</h3></a>
